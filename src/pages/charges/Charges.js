...
import { findAll } from "../../actions/charges";
...
const mapStateToProps = (state) => ({
  data: state.findCharges.data,
  loading: state.findCharges.loading,
  error: state.findCharges.error,
});
...
export default withStyles(styles, { withTheme: true })(
  connect(mapStateToProps, mapDispatchToProps)(Charges)
);
